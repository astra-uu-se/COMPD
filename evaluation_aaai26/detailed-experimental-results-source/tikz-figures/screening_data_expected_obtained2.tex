\begin{figure*}
  \centering     
     ...
     %   \caption{Expected}
     %     \includegraphics[width=\textwidth]{figures/screening-bowl-0.06-10-10-0.99-stdev-3-4-expected.png}
     %     \label{fig:expected}
     % \end{subfigure}
     % \hfill
     ...
     \caption{Comparison between expected and obtained values for
       ...
       and moderate bowl-shaped plate effects.} 
        \label{fig:screening-data-collection-moderate}
\end{figure*}