...
\title{Constraint Optimization of MicroPlate Designs: supplementary information}
\author{
    %Authors
...
Here we provide the complete list of replicated figures and tables containing experimental results from the paper~\cite{plaid2023} (we will use `the PLAID paper' for brevity):
